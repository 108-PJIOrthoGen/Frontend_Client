...
This project is indexed by GitNexus as **Frontend_Client** (3439 symbols, 5759 relationships, 234 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
