...
This project is indexed by GitNexus as **Frontend_Client** (2615 symbols, 4208 relationships, 147 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
