...
This project is indexed by GitNexus as **Frontend_Client** (3534 symbols, 5875 relationships, 233 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
