...
This project is indexed by GitNexus as **Frontend_Client** (3228 symbols, 5433 relationships, 222 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
