...
This project is indexed by GitNexus as **Frontend_Client** (3260 symbols, 5457 relationships, 223 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
