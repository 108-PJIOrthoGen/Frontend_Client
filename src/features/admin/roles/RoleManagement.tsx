...
import { fetchRole, fetchRoleById } from "@/redux/features/admin/roles/roleSlice";
...
const RolePage = () => {
    ...
    const buildQuery = (params: any, sort: any) => {
        ...
        return buildTableQuery({
            params,
            sort,
            filter: clone.name ? `${sfLike("name", clone.name)}` : undefined,
            ...
            <Access permission={ALL_PERMISSIONS.ROLES.GET_PAGINATE}>
                <DataTable<IRole>
                    ...
                    request={async (params, sort, filter) => {
                        ...
                        const page = await dispatch(fetchRole({ query })).unwrap();
                        return {
                            data: page.result,
