...
/**
 * Admin-only user create/edit modal (user table in the admin area).
 * Self-service profile edits live in components/user/ProfileSettingsModal,
 * password changes in components/user/ChangePasswordModal.
 */
interface IProps {
    openModal: boolean;
