      ...
      <Row gutter={[16, 16]} align="top">
        <Col xs={24} xl={16}>
          <Card title="Thông tin đầu vào" styles={{ body: { padding: 20 } }}>
            ...
            <Row gutter={[16, 16]}>
              <Col xs={24} md={12}>
                <Text strong className="mb-2 block text-slate-700">BMI (kg/m²)</Text>
                <InputNumber
                  aria-label="BMI"
                  className="w-full"
                  min={1}
            ...
            <Divider />
            <Title level={5} className="!mb-1 !mt-0">4. Bệnh đồng mắc</Title>
            <Paragraph type="secondary">
              Có thể chọn nhiều mục; để trống nếu không có bệnh đồng mắc trong danh sách.
            </Paragraph>
            <Checkbox.Group
